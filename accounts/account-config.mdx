...
---
This document describes the API that can be used to update the account configuration for a specific bank account. This can be used to enable payment form factors, set limits, fallback accounts, and Incoming blocked/allowed originators. See [The Config sub-object](/accounts/config-subobject.mdx).

...
<Steps>
  ...
  <Step title="Originate a Domestic Wire Transaction">
    Via the API, [Originate a Domestic Wire](/v2/api-reference/transactions/originate-a-domestic-wire)
  </Step>
...
<Steps>
  ...
  <Step title="Originate an International Wire Transaction">
    Via the API, [Originate an International Wire](/v2/api-reference/transactions/originate-an-international-wire)
  </Step>
  <Step title="Pass Parameters">
    Pass the necessary parameters (originating sub_account_id, counterparty_id, amount) and other optional parameters as needed.
```

...
Sub Account Holder 1 at Partner Bank A wants to push \$100 via ACH to Person 2 at Bank B. In this scenario, Sub Account Holder 1 is originating the ACH transaction at Partner Bank A, instructing the bank (via Solid's technology) to:<br />
...
Sub Account Holder 1 (Utility Company) at Partner Bank A wants to pull \$100 via ACH from Person 2 at Bank B. In this scenario, Sub Account Holder 1 (Utility Company) is originating the ACH transaction at Partner Bank A, instructing the bank (via Solid's technology) to:<br />
...
Person 2 at Bank B wants to push \$100 via ACH to Sub Account Holder 1 at Partner Bank A. In this scenario, Person 2 is originating the ACH transaction at Bank B, instructing the bank to:<br />
Debit \$100 from Person 2's Account at Bank B<br />
...
Utility Company at Bank B wants to pull \$100 from via ACH from Sub Account Holder 1 at Partner Bank A. In this scenario, Utility Company is originating the ACH transaction at Bank B, instructing the bank to:<br />
...
To better understand ACH Returns and Reversals, let's dive into the different scenarios surrounding ACH Returns and Reversals.<br /><br />
**ACH Returns**<br />
Filed by the RDFI, ACH Returns are filed in the following scenarios:
<AccordionGroup>
...
**ACH Reversals**<br />
Filed by the RDFI, ACH Reversals are filed in the following scenarios:
<AccordionGroup>
